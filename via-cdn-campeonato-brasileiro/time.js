class Time{
    ...
    atualizarInfos(pontos, golsMarcados, golsSofridos){
        this.pontos += pontos;
    ...
    empate(golsMarcados, golsSofridos){
        this.atualizarInfos(1,golsMarcados, golsSofridos)
    }
    vitoria(golsMarcados, golsSofridos){
        this.atualizarInfos(3, golsMarcados, golsSofridos)
    }
    derrota(golsMarcados, golsSofridos){
        this.atualizarInfos(0, golsMarcados, golsSofridos)
    }
}